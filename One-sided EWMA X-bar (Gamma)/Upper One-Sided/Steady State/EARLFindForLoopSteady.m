% Optimization of EARL for Upward EWMA Xbar for Gamma %
% Steady State %
...
for d = 1:num_deltas
    ...
    [ARL0, ~] = ARLFindUpperSteady(n, 0, K, lam, a_shape, b_scale) ;
    [ARL1, ~] = ARLFindUpperSteady(n, delta, K, lam, a_shape, b_scale) ; 
    [~, SDRL1]= ARLFindUpperSteady(n, delta, K, lam, a_shape, b_scale) ; 

% Optimization of ARL for Downward EWMA Xbar Chart for Gamma %
% Steady State %
% ARL0 = 370.4 (Same as AATS0) % 
...
[lam, K, ARL, SDRL, ARL0] = lamKsewmagammad(n, delta, deltaooc, a_shape, b_scale) ; 
